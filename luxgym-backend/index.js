...
// Chequear conexión a la base de datos antes de iniciar rutas
pool.query('SELECT 1')
  .then(() => {
    console.log('✅ Conectado a la base de datos');

    // Rutas solo se definen después de confirmar conexión
  ...
  .catch(err => {
    ...
    process.exit(1);  // Detener app si no puede conectar a la DB
  });
